window.__require = function e(t, n, r) {
  ...
  GameMgr: [ function(require, module, exports) {
    ...
    exports.GameMgr = exports.aaa = void 0;
    ...
    var WebpSupport_1 = require("./WebpSupport");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    exports.aaa = new WebpSupport_1.WebpClass();
  ...
  WebpSupport: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "e1aa9F4g9dB1ZKstT+rqmmo", "WebpSupport");
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.WebpClass = void 0;
    var WebpClass = function() {
      function WebpClass() {
        cc.sys.isBrowser && cc.sys.os === cc.sys.OS_IOS && this.checkSupport(function(result) {
          cc.sys.capabilities.webp = result;
        });
      }
      WebpClass.prototype.checkSupport = function(cb) {
        var webP = new Image();
        webP.onload = webP.onerror = function() {
          var isSupported = 2 === webP.height;
          cb(isSupported);
        };
