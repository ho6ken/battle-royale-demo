window.__require = function e(t, n, r) {
  ...
  AudioCfg: [ function(require, module, exports) {
    ...
    var AudioSrc;
    (function(AudioSrc) {
      AudioSrc["LoopBgm"] = "bgm/?bundle=audio";
      AudioSrc["Begin"] = "sfx-3/?bundle=audio";
      AudioSrc["Win"] = "sfx-2/?bundle=audio";
      AudioSrc["Lose"] = "sfx-4/?bundle=audio";
      AudioSrc["Rule"] = "sfx-1/?bundle=audio";
  ...
  DebugPnl: [ function(require, module, exports) {
    ...
    var DebugPnl = function(_super) {
      ...
      DebugPnl.prototype.onBtn4Click = function(event, data) {
        EventMgr_1.EventMgr.inst().emit(EventCfg_1.EventSrc.DebugWin);
      };
  ...
  DutyUI: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "7aca0ad475BoqBtarqK8/rx", "DutyUI");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    exports.DutyUI = void 0;
    var UIBase_1 = require("./UIBase");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property, menu = _a.menu;
    var DutyUI = function(_super) {
      __extends(DutyUI, _super);
      function DutyUI() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.prefab = null;
        _this._duty = null;
      ...
      DutyUI.prototype.call = function() {
        var _a;
        var params = [];
        ...
        return __awaiter(this, void 0, Promise, function() {
          ...
          return __generator(this, function(_c) {
            if (null == this._duty) {
              ...
              obj.parent = null !== (_a = this.parent) && void 0 !== _a ? _a : this.node;
              this._duty = obj.getComponent(UIBase_1.UIBase);
            }
            return [ 2, (_b = this._duty).show.apply(_b, params) ];
          });
        });
      };
      DutyUI.prototype.show = function() {
        var params = [];
        for (var _i = 0; _i < arguments.length; _i++) params[_i] = arguments[_i];
        return __awaiter(this, void 0, Promise, function() {
          var _a;
          return __generator(this, function(_b) {
            switch (_b.label) {
             ...
             case 1:
              _b.sent() ? (_a = this._duty).show.apply(_a, params) : this.call.apply(this, params);
              return [ 2 ];
            }
          });
        });
      };
      DutyUI.prototype.hide = function() {
        var params = [];
        for (var _i = 0; _i < arguments.length; _i++) params[_i] = arguments[_i];
        return __awaiter(this, void 0, Promise, function() {
          var _a;
          return __generator(this, function(_b) {
            switch (_b.label) {
             ...
             case 1:
              _b.sent() ? (_a = this._duty).hide.apply(_a, params) : null;
              return [ 2 ];
            }
          });
        });
      };
      __decorate([ property(cc.Prefab) ], DutyUI.prototype, "prefab", void 0);
      __decorate([ property(cc.Node) ], DutyUI.prototype, "parent", void 0);
      DutyUI = __decorate([ ccclass, menu("ui/duty") ], DutyUI);
      return DutyUI;
    }(UIBase_1.UIBase);
    exports.DutyUI = DutyUI;
    cc._RF.pop();
  }, {
    "./UIBase": "UIBase"
  } ],
  EnemyAtk: [ function(require, module, exports) {
    ...
    var GridDefine_1 = require("../../../define/GridDefine");
    var TileDefine_1 = require("../../../define/TileDefine");
    var TileAtk_1 = require("../../act/TileAtk");
    ...
    var EnemyAtk = function(_super) {
      ...
      EnemyAtk.prototype.business = function(param) {
        return __awaiter(this, void 0, Promise, function() {
          ...
          return __generator(this, function(_a) {
            this._param = param;
            this._cmd = param.load.length > 0 ? param.load[param.load.length - 1] : new GridCmd_1.GridCmd();
  ...
  EnemyWalk: [ function(require, module, exports) {
    ...
    var GridDefine_1 = require("../../../define/GridDefine");
    var TileDefine_1 = require("../../../define/TileDefine");
    var TileCd_1 = require("../../act/TileCd");
    ...
    var EnemyWalk = function(_super) {
      ...
      EnemyWalk.prototype.business = function(param) {
        return __awaiter(this, void 0, Promise, function() {
          ...
          return __generator(this, function(_a) {
            ...
            this._cmd.deed.size > 0 && this._param.load.push(this._cmd);
            return [ 2, true ];
          });
        });
      };
      EnemyWalk.prototype.walk = function(tile) {
        ...
        for (var i = 0; i < tile.dex; i++) {
          if (this.contacted(tile.pos, tile)) break;
          this.step(tile);
        }
      ...
      EnemyWalk.prototype.cost = function(from, to) {
        ...
        if (tile && tile.group == TileDefine_1.TileGroup.Norm && tile.id >= 0) return Math.abs(to.x - from.x) + Math.abs(to.y - from.y);
  ...
  EventCfg: [ function(require, module, exports) {
    ...
    (function(EventSrc) {
      ...
      EventSrc[EventSrc["DebugWin"] = 6] = "DebugWin";
      EventSrc[EventSrc["Fight"] = 7] = "Fight";
      EventSrc[EventSrc["Charge"] = 8] = "Charge";
      EventSrc[EventSrc["Ultimate"] = 9] = "Ultimate";
      EventSrc[EventSrc["Crushed"] = 10] = "Crushed";
      EventSrc[EventSrc["Lose"] = 11] = "Lose";
    ...
    var GridCtrl = function(_super) {
      ...
      GridCtrl.prototype.genNorm = function() {
        ...
        GridDefine_1.FOR_COL_ROW(function(pos) {
          ...
          tile.type = _this._model.getRandNorm();
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              ...
              GridDefine_1.FOR_COL_ROW(function(pos) {
                var tile = _this._model.getTile(pos);
                cmd.add(tile, new TileTrans_1.TileTrans(tile.type));
  ...
  GridDirector: [ function(require, module, exports) {
    ...
    var GridDefine_1 = require("../../define/GridDefine");
    var TileDefine_1 = require("../../define/TileDefine");
    var SfxView_1 = require("./view/SfxView");
    var GridDirector = function() {
      function GridDirector(host) {
        ...
        this._perform.set(TileDefine_1.TileAct.Atk, this.atk);
        this._perform.set(TileDefine_1.TileAct.Cd, this.cooldown);
      }
      ...
      GridDirector.prototype.select = function(act, tile) {
        var time = .1;
        this._tween.call(function() {
          return tile.select(act.selected);
        });
        this._tween.call(function() {
          return tile.node.zIndex = act.selected ? TileDefine_1.TileGroup.Max : tile.group;
        });
        this._tween.to(time, {
          scale: act.selected ? 1.3 : 1
        });
        return time;
      };
      GridDirector.prototype.swap = function(act, tile) {
        var _this = this;
        var time = tile.group == TileDefine_1.TileGroup.Enemy ? .6 : .3;
        var x = (act.target.x + .5) * TileDefine_1.TILE_W;
        var y = (act.target.y + .5) * TileDefine_1.TILE_H;
        this._tween.call(function() {
          tile.group == TileDefine_1.TileGroup.Enemy && _this.setLayer(true);
        });
        this._tween.call(function() {
          tile.node.zIndex = tile.group == TileDefine_1.TileGroup.Norm && _this._layer ? tile.group : TileDefine_1.TileGroup.Max;
          tile.walk();
        });
        this._tween.to(time, {
      ...
      GridDirector.prototype.move = function(act, tile) {
        var time = act.skip ? 0 : tile.group == TileDefine_1.TileGroup.Enemy ? .8 : .3;
        var x = (act.target.x + .5) * TileDefine_1.TILE_W;
        var y = (act.target.y + .5) * TileDefine_1.TILE_H;
        if (time <= 0) tile.node.setPosition(x, y); else {
          this._tween.call(function() {
            tile.node.zIndex = TileDefine_1.TileGroup.Max;
            tile.walk();
          });
          this._tween.to(time, {
            position: cc.v3(x, y, 0)
      ...
      GridDirector.prototype.slip = function(act, tile) {
        ...
        act.path.forEach(function(pos) {
          ...
          _this._tween.call(function() {
            return tile.node.zIndex = TileDefine_1.TileGroup.Max;
          });
      ...
      GridDirector.prototype.hit = function(act, tile) {
        var time = tile.group == TileDefine_1.TileGroup.Enemy ? .8 : .2;
        var half = time / 2;
        this._tween.call(function() {
          tile.node.scale = 1;
          tile.hit();
        ...
        this._tween.call(function() {
          switch (act.eff) {
           case TileDefine_1.TileType.Cross:
            SfxView_1.SfxView.inst.showCross(pos);
            break;

           case TileDefine_1.TileType.Thunder:
            SfxView_1.SfxView.inst.showThunder(pos);
            break;

           case TileDefine_1.TileType.Cyclone:
            SfxView_1.SfxView.inst.showCyclone(pos);
          }
        });
        this._tween.delay(time);
        this._tween.call(function() {
      ...
      GridDirector.prototype.atk = function(act, tile) {
        ...
        this._tween.call(function() {
          tile.atk().then(function() {
            var pos = tile.node.position;
            switch (tile.type) {
             case TileDefine_1.TileType.Warrior:
              SfxView_1.SfxView.inst.showWarriorAtk(pos);
              break;

             case TileDefine_1.TileType.Archer:
              SfxView_1.SfxView.inst.showArcherAtk(pos);
              break;

             case TileDefine_1.TileType.Armor:
              SfxView_1.SfxView.inst.showArmorAtk(pos);
            }
          });
        });
        this._tween.delay(time);
      ...
      GridDirector.prototype.setLayer = function(max) {
        if (this._layer != max) {
          this._layer = max;
          this._host.maskActive(max);
          Array.from(this._host._tiles.values()).forEach(function(elm) {
            elm.group == TileDefine_1.TileGroup.Enemy || elm.group == TileDefine_1.TileGroup.Player ? elm.node.zIndex = max ? TileDefine_1.TileGroup.Max : elm.group : elm.node.zIndex = elm.group;
          });
        }
      };
      return GridDirector;
  ...
  GridModel: [ function(require, module, exports) {
    ...
    var GridDefine_1 = require("../../../define/GridDefine");
    var TileDefine_1 = require("../../../define/TileDefine");
    var StageCtrl_1 = require("../ctrl/StageCtrl");
    ...
    var GridModel = function(_super) {
      ...
      GridModel.prototype.getRandEnemy = function() {
        var data = StageCtrl_1.StageCtrl.inst.data.enemy;
        var idx = RandUtil_1.RandUtil.randWeights(data.weights);
      ...
      GridModel.prototype.getCrushesH = function(center) {
        ...
        res.length >= 2 ? res.unshift(center) : res = [];
        return res;
      };
      ...
      GridModel.prototype.getCrushesO = function(center) {
        ...
        res.length >= 3 ? res.unshift(center) : res = [];
        return res;
      };
      GridModel.prototype.getCrushesT = function(center) {
        ...
        res.length >= 4 ? res.unshift(center) : res = [];
        return res;
      };
  ...
  GridView: [ function(require, module, exports) {
    ...
    var GridView = function(_super) {
      ...
      GridView.prototype.onEnable = function() {
        ...
        this.mask.zIndex = TileDefine_1.TileGroup.Max - 1;
      ...
      GridView.prototype.maskActive = function(value) {
        this.mask.active = value;
      };
      __decorate([ property(cc.Node) ], GridView.prototype, "mask", void 0);
  ...
  LoseView: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "97bcd7iKBRCPZ5+7vQbhzPN", "LoseView");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var LoseView = function(_super) {
      ...
      LoseView.prototype.onLoad = function() {
        this.node.active = false;
        this.node.x = 0;
      };
      LoseView.prototype.play = function() {
        return __awaiter(this, void 0, Promise, function() {
          var _a, _b;
          return __generator(this, function(_c) {
            switch (_c.label) {
             case 0:
              _b = (_a = SfxAudio_1.SfxAudio.inst()).play;
              return [ 4, AssetMgr_1.AssetMgr.inst().loadAsset(AudioCfg_1.AudioSrc.Lose, cc.AudioClip, true) ];

             case 1:
              _b.apply(_a, [ _c.sent() ]);
              this.node.active = true;
              return [ 4, WaitUtil_1.WaitUtil.waitSec(2.5) ];
  ...
  PrefabCfg: [ function(require, module, exports) {
    ...
    var PrefabSrc;
    (function(PrefabSrc) {
      PrefabSrc["Tile"] = "Tile/?bundle=prefab";
      PrefabSrc["CrushH"] = "Particle_12/?bundle=prefab";
      PrefabSrc["CrushV"] = "Particle_13/?bundle=prefab";
      PrefabSrc["Cross"] = "Particle_14/?bundle=prefab";
      PrefabSrc["Thunder"] = "Particle_15/?bundle=prefab";
      PrefabSrc["Cyclone"] = "Particle_16/?bundle=prefab";
      PrefabSrc["WarriorAtk"] = "Particle_01/?bundle=prefab";
      PrefabSrc["ArcherAtk"] = "Particle_02/?bundle=prefab";
      PrefabSrc["ArmorAtk"] = "Particle_03/?bundle=prefab";
  ...
  RuleBtnUI: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "c1413eVuWxJ/Ze8LP0y3Uzc", "RuleBtnUI");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    exports.RuleBtnUI = void 0;
    var DutyUI_1 = require("../../comm/cmpt/ui/DutyUI");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var RuleBtnUI = function(_super) {
      __extends(RuleBtnUI, _super);
      function RuleBtnUI() {
        return null !== _super && _super.apply(this, arguments) || this;
      }
      RuleBtnUI.prototype.onClick = function(event, data) {
        this.call();
      };
      RuleBtnUI = __decorate([ ccclass ], RuleBtnUI);
      return RuleBtnUI;
    }(DutyUI_1.DutyUI);
    exports.RuleBtnUI = RuleBtnUI;
    cc._RF.pop();
  }, {
    "../../comm/cmpt/ui/DutyUI": "DutyUI"
  } ],
  RuleUI: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "900a21C3RBEAasfd8EGKHOk", "RuleUI");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    exports.RuleUI = void 0;
    var UIBase_1 = require("../../comm/cmpt/ui/UIBase");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var RuleUI = function(_super) {
      ...
      RuleUI.prototype.onClose = function(event, data) {
        this.hide();
      };
      RuleUI = __decorate([ ccclass ], RuleUI);
      return RuleUI;
    }(UIBase_1.UIBase);
    exports.RuleUI = RuleUI;
    cc._RF.pop();
  }, {
    "../../comm/cmpt/ui/UIBase": "UIBase"
  } ],
  RuleView: [ function(require, module, exports) {
    ...
    var RuleView = function(_super) {
      ...
      RuleView.prototype.setColor = function() {
        ...
        this._finished && AssetMgr_1.AssetMgr.inst().loadAsset(AudioCfg_1.AudioSrc.Rule, cc.AudioClip, true).then(function(audio) {
          return SfxAudio_1.SfxAudio.inst().play(audio);
        });
      };
  ...
  SfxView: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "9ef1b+YeLhB3IvprA4IH+hO", "SfxView");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    exports.SfxView = void 0;
    var PrefabCfg_1 = require("../../../cfg/PrefabCfg");
    var AssetMgr_1 = require("../../../comm/asset/AssetMgr");
    var ReplayFx_1 = require("../../../comm/cmpt/ReplayFx");
    var ObjPool_1 = require("../../../comm/pool/ObjPool");
    var WaitUtil_1 = require("../../../comm/util/WaitUtil");
    var GridDefine_1 = require("../../../define/GridDefine");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var SfxView = function(_super) {
      __extends(SfxView, _super);
      function SfxView() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this._pool = new ObjPool_1.ObjPool();
        _this.host = null;
        return _this;
      }
      SfxView_1 = SfxView;
      Object.defineProperty(SfxView, "inst", {
        get: function() {
          return this._inst;
        },
        enumerable: false,
      ...
      SfxView.prototype.onLoad = function() {
        SfxView_1._inst = this;
        this.host.anchorX = 0;
        this.host.anchorY = 0;
        this.host.x = -GridDefine_1.GRID_W / 2;
        this.host.y = -GridDefine_1.GRID_H / 2;
        this.host.width = GridDefine_1.GRID_W;
        this.host.height = GridDefine_1.GRID_H;
      };
      SfxView.prototype.playSfx = function(key, pos, time) {
        return __awaiter(this, void 0, Promise, function() {
          var obj, _a, _b, sfx;
          return __generator(this, function(_c) {
            switch (_c.label) {
             case 0:
              return [ 4, this._pool.fetch(key) ];

             case 1:
              obj = _c.sent();
              if (!(null == obj)) return [ 3, 3 ];
              _b = (_a = cc).instantiate;
              return [ 4, AssetMgr_1.AssetMgr.inst().loadAsset(key, cc.Prefab, true) ];

             case 2:
              obj = _b.apply(_a, [ _c.sent() ]);
              _c.label = 3;

             case 3:
              sfx = obj.getComponent(ReplayFx_1.ReplayFx);
              obj.setParent(this.host);
              obj.active = false;
              obj.setPosition(pos);
              sfx.play();
              return [ 4, WaitUtil_1.WaitUtil.waitMs(time, sfx) ];
      ...
      SfxView.prototype.showCrushH = function(pos) {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, this.playSfx(PrefabCfg_1.PrefabSrc.CrushH, pos, 500) ];
      ...
      SfxView.prototype.showCrushV = function(pos) {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, this.playSfx(PrefabCfg_1.PrefabSrc.CrushV, pos, 500) ];
      ...
      SfxView.prototype.showCross = function(pos) {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, this.playSfx(PrefabCfg_1.PrefabSrc.Cross, pos, 500) ];
      ...
      SfxView.prototype.showThunder = function(pos) {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, this.playSfx(PrefabCfg_1.PrefabSrc.Thunder, pos, 500) ];
      ...
      SfxView.prototype.showCyclone = function(pos) {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, this.playSfx(PrefabCfg_1.PrefabSrc.Cyclone, pos, 500) ];
      ...
      SfxView.prototype.showWarriorAtk = function(pos) {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, this.playSfx(PrefabCfg_1.PrefabSrc.WarriorAtk, pos, 500) ];
      ...
      SfxView.prototype.showArcherAtk = function(pos) {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, this.playSfx(PrefabCfg_1.PrefabSrc.ArcherAtk, pos, 500) ];
      ...
      SfxView.prototype.showArmorAtk = function(pos) {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, this.playSfx(PrefabCfg_1.PrefabSrc.ArmorAtk, pos, 500) ];
      ...
      var SfxView_1;
      SfxView._inst = null;
      __decorate([ property(cc.Node) ], SfxView.prototype, "host", void 0);
      SfxView = SfxView_1 = __decorate([ ccclass ], SfxView);
      return SfxView;
    }(cc.Component);
    exports.SfxView = SfxView;
    cc._RF.pop();
  }, {
    "../../../cfg/PrefabCfg": "PrefabCfg",
    "../../../comm/asset/AssetMgr": "AssetMgr",
    "../../../comm/cmpt/ReplayFx": "ReplayFx",
    "../../../comm/pool/ObjPool": "ObjPool",
    "../../../comm/util/WaitUtil": "WaitUtil",
    "../../../define/GridDefine": "GridDefine"
  } ],
  ...
  SpinCfg: [ function(require, module, exports) {
    ...
    var SpineSrc;
    (function(SpineSrc) {
      SpineSrc["Blue"] = "tile/blue/SymbolH4/?bundle=spine";
      SpineSrc["Green"] = "tile/green/SymbolH5/?bundle=spine";
      SpineSrc["Red"] = "tile/red/SymbolH2/?bundle=spine";
      SpineSrc["Yellow"] = "tile/yellow/SymbolH1/?bundle=spine";
      SpineSrc["Hero"] = "tile/hero/SymbolW1/?bundle=spine";
            ...
            return [ 2, new Promise(function(resolve) {
              return __awaiter(_this, void 0, void 0, function() {
                return __generator(this, function(_a) {
                  switch (_a.label) {
                   case 0:
                    return [ 4, WaitUtil_1.WaitUtil.waitSec(entry.animation.duration / this.spine.timeScale, this.spine) ];
  ...
  StageCtrl: [ function(require, module, exports) {
    ...
    var StageCtrl = function(_super) {
      ...
      StageCtrl.prototype.fight = function() {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            AssetMgr_1.AssetMgr.inst().loadAsset(AudioCfg_1.AudioSrc.Begin, cc.AudioClip, true).then(function(audio) {
              BgmAudio_1.BgmAudio.inst().pause();
              SfxAudio_1.SfxAudio.inst().play(audio, function() {
                return BgmAudio_1.BgmAudio.inst().resume();
              });
            });
      ...
      StageCtrl.prototype.lose = function() {
        this._view.playLose();
      };
      var StageCtrl_1;
      StageCtrl._inst = null;
      __decorate([ EventDecor_1.onEvent(EventCfg_1.EventSrc.Crushed) ], StageCtrl.prototype, "crushed", null);
      __decorate([ EventDecor_1.onEvent(EventCfg_1.EventSrc.DebugWin) ], StageCtrl.prototype, "win", null);
      __decorate([ EventDecor_1.onEvent(EventCfg_1.EventSrc.Lose) ], StageCtrl.prototype, "lose", null);
      StageCtrl = StageCtrl_1 = __decorate([ ccclass, EventDecor_1.onEnable() ], StageCtrl);
      return StageCtrl;
    }(cc.Component);
  ...
  StageModel: [ function(require, module, exports) {
    ...
    var StageModel = function() {
      ...
      Object.defineProperty(StageModel.prototype, "winner", {
        get: function() {
      ...
      StageModel.prototype.decRule = function(type, num) {
        if (this.rules.has(type)) {
          var curr = this.rules.get(type);
          curr -= num;
  ...
  StageView: [ function(require, module, exports) {
    ...
    var LoseView_1 = require("./LoseView");
    ...
    var StageView = function(_super) {
      ...
      StageView.prototype.playWin = function() {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, this.win.play() ];
      ...
      StageView.prototype.playLose = function() {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, this.lose.play() ];
      ...
      __decorate([ property(WinView_1.WinView) ], StageView.prototype, "win", void 0);
      __decorate([ property(LoseView_1.LoseView) ], StageView.prototype, "lose", void 0);
  ...
  TextureCfg: [ function(require, module, exports) {
    ...
    var TextureSrc;
    (function(TextureSrc) {
      TextureSrc["Blue"] = "tile/blue/?bundle=texture";
      TextureSrc["Green"] = "tile/green/?bundle=texture";
      TextureSrc["Red"] = "tile/red/?bundle=texture";
      TextureSrc["Yellow"] = "tile/yellow/?bundle=texture";
      TextureSrc["Stone"] = "tile/stone/?bundle=texture";
      TextureSrc["Rock"] = "tile/rock/?bundle=texture";
      TextureSrc["Potion"] = "tile/potion/?bundle=texture";
      TextureSrc["Cross"] = "tile/cross/?bundle=texture";
      TextureSrc["Thunder"] = "tile/thunder/?bundle=texture";
      TextureSrc["Cyclone"] = "tile/cyclone/?bundle=texture";
      TextureSrc["Warrior"] = "tile/warrior/?bundle=texture";
      TextureSrc["Archer"] = "tile/archer/?bundle=texture";
      TextureSrc["Armor"] = "tile/armor/?bundle=texture";
      TextureSrc["Hero"] = "tile/hero/?bundle=texture";
      TextureSrc["PlayerHp"] = "tile/hp-green/?bundle=texture";
      TextureSrc["EnemyHp"] = "tile/hp-red/?bundle=texture";
    })(TextureSrc = exports.TextureSrc || (exports.TextureSrc = {}));
    cc._RF.pop();
  }, {} ],
  TileAtk: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "a4974403DpPe5/MJFkqdw3p", "TileAtk");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    exports.TileAtk = void 0;
    var TileDefine_1 = require("../../define/TileDefine");
    var GridCmd_1 = require("../mvc/GridCmd");
    var TileAtk = function(_super) {
      __extends(TileAtk, _super);
      function TileAtk() {
        return _super.call(this) || this;
      }
      Object.defineProperty(TileAtk.prototype, "type", {
        get: function() {
          return TileDefine_1.TileAct.Atk;
        },
        enumerable: false,
        configurable: true
      });
    ...
    exports.TileAtk = TileAtk;
    cc._RF.pop();
  }, {
    "../../define/TileDefine": "TileDefine",
    "../mvc/GridCmd": "GridCmd"
  } ],
  TileCd: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "c450anAusFFPqsM9glbZvaJ", "TileCd");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    exports.TileCd = void 0;
    var TileDefine_1 = require("../../define/TileDefine");
    var GridCmd_1 = require("../mvc/GridCmd");
    var TileCd = function(_super) {
      __extends(TileCd, _super);
      function TileCd() {
        return null !== _super && _super.apply(this, arguments) || this;
      }
      Object.defineProperty(TileCd.prototype, "type", {
        get: function() {
          return TileDefine_1.TileAct.Cd;
        },
        enumerable: false,
        configurable: true
      });
  ...
  TileDefine: [ function(require, module, exports) {
    ...
    (function(TileGroup) {
      ...
      TileGroup[TileGroup["Max"] = 10] = "Max";
    ...
    (function(TileAct) {
      ...
      TileAct[TileAct["Atk"] = 13] = "Atk";
      TileAct[TileAct["Cd"] = 14] = "Cd";
  ...
  TileView: [ function(require, module, exports) {
    ...
    var EventCfg_1 = require("../../../cfg/EventCfg");
    var SpinCfg_1 = require("../../../cfg/SpinCfg");
    var TextureCfg_1 = require("../../../cfg/TextureCfg");
    var AssetMgr_1 = require("../../../comm/asset/AssetMgr");
    var Spine_1 = require("../../../comm/cmpt/Spine");
    var EventMgr_1 = require("../../../comm/event/EventMgr");
    var WaitUtil_1 = require("../../../comm/util/WaitUtil");
    var TileDefine_1 = require("../../../define/TileDefine");
    var TileModel_1 = require("../model/TileModel");
    ...
    var TileView = function(_super) {
      ...
      Object.defineProperty(TileView.prototype, "type", {
        get: function() {
      ...
      Object.defineProperty(TileView.prototype, "cd", {
        set: function(value) {
          var _a;
          this.cooldown.string = null !== (_a = null === value || void 0 === value ? void 0 : value.toString()) && void 0 !== _a ? _a : "0";
        },
        enumerable: false,
        configurable: true
      });
      ...
      TileView.prototype.setType = function(type) {
        return __awaiter(this, void 0, Promise, function() {
          var url, _a, url_1, _b, _c;
          return __generator(this, function(_d) {
            switch (_d.label) {
             case 0:
              this._model.type = type;
              if (!(type != TileDefine_1.TileType.None)) return [ 3, 4 ];
              url = TextureCfg_1.TextureSrc[TileDefine_1.TileType[type]];
              _a = this.avatar;
              return [ 4, AssetMgr_1.AssetMgr.inst().loadAsset(url, cc.SpriteFrame, true) ];
             ...
             case 1:
              ...
              if (!this.spine) return [ 3, 3 ];
              if (!(this.group == TileDefine_1.TileGroup.Norm || this.group == TileDefine_1.TileGroup.Player)) return [ 3, 3 ];
              url_1 = SpinCfg_1.SpineSrc[TileDefine_1.TileType[type]];
              _c = (_b = this.spine).init;
              return [ 4, AssetMgr_1.AssetMgr.inst().loadAsset(url_1, sp.SkeletonData, true) ];
             ...
             case 3:
              this.cooldown.node.active = this.group == TileDefine_1.TileGroup.Player || this.group == TileDefine_1.TileGroup.Enemy;
      ...
      TileView.prototype.decHp = function(value) {
        ...
        this.refreshBar();
        this.refreshBlock();
        this._model.group == TileDefine_1.TileGroup.Player && this._model.currHp <= 0 && EventMgr_1.EventMgr.inst().emit(EventCfg_1.EventSrc.Lose);
      };
        ...
        return __awaiter(this, void 0, Promise, function() {
          ...
          return __generator(this, function(_c) {
            switch (_c.label) {
             ...
             case 2:
              tween = cc.tween(this.avatar.node);
              tween.to(.1, {
                color: cc.Color.RED
              });
              tween.to(.1, {
      ...
      TileView.prototype.select = function(selected) {
        ...
        switch (this.group) {
         case TileDefine_1.TileGroup.Norm:
          spineDyn(true);
          if (selected) self.spine.playLoop("Idle"); else if ("Idle" == self.spine.key) {
            self.spine.stop();
            spineDyn(false);
          }
          break;
         ...
         case TileDefine_1.TileGroup.Player:
          spineDyn(true);
          if (selected) self.spine.playOnce("WinFreeGame").then(function() {
            self.spine.playLoop("AnticipationLoop");
          }); else if ("WinFreeGame" == self.spine.key || "AnticipationLoop" == self.spine.key) {
            self.spine.stop();
            spineDyn(false);
          }
        }
      ...
      TileView.prototype.crushed = function() {
        ...
        if (self.group == TileDefine_1.TileGroup.Norm) {
          spineDyn(true);
          self.spine.playOnce("Win").then(function() {
            if ("Win" == self.spine.key) {
              self.spine.stop();
              spineDyn(false);
            }
          });
      ...
      __decorate([ property(Spine_1.Spine) ], TileView.prototype, "spine", void 0);
      __decorate([ property(cc.Animation) ], TileView.prototype, "anim", void 0);
      __decorate([ property(cc.Label) ], TileView.prototype, "cooldown", void 0);
  ...
  UIBase: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "0d6281lIZdApZ5eFxiUAQkN", "UIBase");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
  ...
  UltView: [ function(require, module, exports) {
    ...
    var UltView = function(_super) {
      ...
      UltView.prototype.clear = function() {
        ...
        null === (_a = this.btnsfx) || void 0 === _a ? void 0 : _a.stop();
      };
      ...
      UltView.prototype.onClick = function(event, data) {
        ...
        if (this._energy >= GameDefine_1.MAX_ENERGY) {
          this.clear();
          null === (_a = this.ultSfx) || void 0 === _a ? void 0 : _a.play();
      ...
      __decorate([ property(ReplayFx_1.ReplayFx) ], UltView.prototype, "btnsfx", void 0);
      __decorate([ property(ReplayFx_1.ReplayFx) ], UltView.prototype, "ultSfx", void 0);
  ...
  WinView: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "20e41aLJ4dFAYMz+LRcQmSa", "WinView");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var WinView = function(_super) {
      ...
      WinView.prototype.play = function() {
        return __awaiter(this, void 0, Promise, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              this.node.active = true;
              AssetMgr_1.AssetMgr.inst().loadAsset(AudioCfg_1.AudioSrc.Win, cc.AudioClip, true).then(function(audio) {
                BgmAudio_1.BgmAudio.inst().pause();
                SfxAudio_1.SfxAudio.inst().play(audio, function() {
                  return BgmAudio_1.BgmAudio.inst().resume();
                });
              });
              return [ 4, this.win.playOnce("LegendWin") ];
      ...
      __decorate([ property(Spine_1.Spine) ], WinView.prototype, "win", void 0);
...
}, {}, [ "AudioCfg", "EventCfg", "PrefabCfg", "SpinCfg", "TextureCfg", "AssetLoader", "AssetMgr", "BgmAudio", "SfxAudio", "ReplayFx", "Spine", "CanvasAdapt", "DesktopAdapt", "WidgetAdapt", "DutyUI", "UIBase", "EventDecor", "EventMgr", "NumExtend", "StrExtend", "CmptPool", "ObjPool", "DataDriven", "RandUtil", "SimulateFx", "Singleton", "WaitUtil", "WorkChain", "DebugPnl", "DebugTool", "GameDefine", "GridDefine", "TileDefine", "GameMgr", "TileAtk", "TileCd", "TileCrush", "TileDie", "TileFall", "TileHit", "TileMove", "TileNext", "TileSelect", "TileSkill", "TileSlip", "TileSpawn", "TileSwap", "TileTrans", "TileWait", "GridCmd", "GridDirector", "GridCtrl", "GridCtrlBase", "StageCtrl", "GridModel", "GridModelBase", "StageModel", "TileModel", "TileModelBase", "GridView", "LoseView", "RuleView", "SfxView", "StageView", "TileView", "UltView", "WinView", "SelectHandler", "ComboWork", "CrushWork", "DropWork", "ResetWork", "SlipWork", "StuffWork", "EnemyAtk", "EnemyWalk", "NormAtk", "SkillAtk", "UltAtk", "FirstCheck", "LimitCheck", "MoveCheck", "SecondCheck", "SwapCheck", "EnemyPort", "NormPort", "PlayerPort", "SkillPort", "RuleBtnUI", "RuleUI" ]);